...
// API buttons here:
const endpoints = [
  { label: 'Get Jenkins Info', endpoint: 'getJenkinsInfo', args: ['']},
  { label: 'Get Jenkins Jobs', endpoint: 'getJenkinsJobs', args: ['']},
  { label: 'Get Jenkins Views', endpoint: 'getJenkinsViews', args: ['']},
  { label: 'Login', endpoint: 'login', args: ['']},
  { label: 'Get Que API', endpoint: 'getQueAPI', args: ['']},
  { label: 'Get Load API', endpoint: 'getLoadAPI', args: ['']},
  { label: 'Get Payless Find Store Builds', endpoint: 'getBuilds', args: ['payless-findstore']},
  { label: 'Start Payless Find-Store', endpoint: 'startJob', args: ['find-store']}
];
